...
(() => {
  ...
  style.textContent = `
    ...
    .ah-game-question-option.correct,.ah-game-question-option.is-correct{border-color:var(--green)!important;background:color-mix(in srgb,var(--green) 13%,var(--card))!important;color:color-mix(in srgb,var(--green) 78%,var(--text))!important;box-shadow:0 5px 0 color-mix(in srgb,var(--green) 34%,var(--card)),0 11px 20px color-mix(in srgb,var(--green) 14%,transparent)!important}
    ...
    .ah-game-question-option.wrong,.ah-game-question-option.is-wrong{border-color:var(--red)!important;background:color-mix(in srgb,var(--red) 10%,var(--card))!important;color:color-mix(in srgb,var(--red) 78%,var(--text))!important;box-shadow:0 5px 0 color-mix(in srgb,var(--red) 26%,var(--card)),0 11px 20px color-mix(in srgb,var(--red) 10%,transparent)!important}

...
const BUILD_ID = 'v94-offline-all-scripts-20260829';
...
const APP_SHELL = [
  ...
  './phase3-intelligence.js?v=command-tools-v14-direct-course',
  ...
  './question-bank-performance.js?v=10-note-return',
  ...
  './deleted-questions.js?v=trash3-watchdog',
  ...
  './vocabulary-master-tool.js?v=vm-native-v26-dedicated-mcq',
  ...
  './daily-streak-card.js?v=streak-v2-p3fix',

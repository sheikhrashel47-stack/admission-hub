...
(function(){
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    .p3-dashboard-v3{position:relative;z-index:0;width:calc(100% + 32px);max-width:none;margin:-18px -16px 0;padding:18px 0 92px;color:#183246;background:linear-gradient(145deg,#f8fcff 0%,#eef8fa 46%,#f8f5ff 100%);border-radius:0;overflow:hidden}

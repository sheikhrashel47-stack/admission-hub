...
(function(){
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    .p3-dashboard-v3{position:relative;z-index:0;max-width:640px;padding:16px 14px 92px;color:#183246;background:linear-gradient(145deg,#f8fcff 0%,#eef8fa 46%,#f8f5ff 100%);border-radius:32px;overflow:hidden}

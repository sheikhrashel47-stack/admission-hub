...
(function(){
  ...
  const style=document.createElement('style');style.textContent=`
    ...
    .p3-dashboard-v3{position:relative;z-index:0;width:calc(100% + 32px);max-width:none;margin:0 -16px;padding:12px 0 92px;color:#183246;background:linear-gradient(145deg,#f8fcff 0%,#eef8fa 46%,#f8f5ff 100%);border-radius:0;overflow:hidden}
    ...
    .p3-command-section-v3{margin:14px 14px 16px;padding:19px 0 16px;background:rgba(255,255,255,.67);border:1px solid rgba(255,255,255,.9);border-radius:26px;box-shadow:0 11px 26px rgba(82,128,164,.09);backdrop-filter:blur(16px)}.p3-command-section-v3 .p3-section-head-v3{padding:0 19px}.p3-section-head-v3 b{color:#18344a}.p3-swipe-hint-v3{color:#8396a7}.p3-command-card-v3{position:relative;overflow:hidden;min-height:100px;padding:14px 13px;background:rgba(255,255,255,.78);border:1px solid rgba(255,255,255,.95);border-radius:18px;box-shadow:0 7px 17px rgba(93,138,170,.10),0 0 0 1px rgba(161,210,212,.08) inset;transition:transform .16s ease,box-shadow .16s ease}.p3-command-card-v3:before{content:"";position:absolute;right:-16px;top:-22px;width:56px;height:56px;border:1px solid rgba(113,192,198,.15);border-radius:50%;pointer-events:none}.p3-command-card-v3:after{content:"›";position:absolute;right:10px;top:50%;width:20px;height:20px;transform:translateY(-50%);display:grid;place-items:center;border:1px solid rgba(123,165,185,.2);border-radius:50%;color:#7e9bae;font-size:18px;line-height:1}.p3-command-card-v3:active{transform:scale(.985);box-shadow:0 3px 8px rgba(93,138,170,.10)}.p3-command-icon-v3{font-size:26px}.p3-command-title-v3{font-size:14px;color:#18344a}.p3-command-subtitle-v3{font-size:10px;color:#718796}
    .p3-two-col-v3{gap:14px;margin:0 14px 14px}.p3-progress-v3,.p3-quick-stats-v3{position:relative;min-height:246px;background:rgba(255,255,255,.72);border:1px solid rgba(255,255,255,.92);border-radius:23px;box-shadow:0 10px 22px rgba(92,132,165,.08);overflow:hidden}.p3-progress-body-v3{gap:12px;min-height:185px}.p3-circle-container{position:relative;width:92px;height:92px;flex:0 0 92px}.p3-circle-container:before,.p3-circle-container:after{content:"";position:absolute;border:2px solid rgba(102,194,210,.16);border-radius:50%;pointer-events:none}.p3-circle-container:before{inset:-7px}.p3-circle-container:after{inset:7px;border-color:rgba(157,155,237,.14)}.p3-circular-chart{position:relative;z-index:1}.p3-circle-bg{stroke:#e7f1f4}.p3-circle{stroke:#20b795}.p3-percentage{fill:#1a5262}.p3-prog-icon-box{background:rgba(241,250,252,.75);color:#4e8e9a;border:1px solid rgba(145,204,211,.18)}.p3-prog-stat small{color:#879aa5}.p3-prog-stat b{color:#1d5360}.p3-more-btn{color:#8295a7}.p3-quick-grid-v3{position:relative;z-index:1;gap:9px}.p3-quick-stats-v3:after{content:"";position:absolute;left:18px;right:18px;bottom:18px;height:34px;opacity:.34;background:linear-gradient(160deg,transparent 42%,#77bde0 44%,#77bde0 48%,transparent 50%) 0 14px/52px 24px repeat-x;pointer-events:none}.p3-quick-box{background:rgba(249,252,255,.73);border:1px solid rgba(255,255,255,.85);box-shadow:0 5px 13px rgba(111,149,179,.06);min-height:76px}.p3-quick-data b{color:#18344a}.p3-quick-data small{color:#758a99}.p3-special-section-v3{margin:18px 14px 0}.p3-special-grid-v3{background:rgba(255,255,255,.68);border-color:rgba(179,211,222,.42);box-shadow:0 9px 21px rgba(85,132,168,.07)}.p3-special-card-v3{background:rgba(255,255,255,.46)}.p3-routine-today-v3{margin-left:14px;margin-right:14px;background:linear-gradient(140deg,rgba(255,255,255,.82),rgba(232,251,248,.88),rgba(244,240,255,.82))!important;border-color:rgba(137,205,209,.42)!important;box-shadow:0 8px 0 rgba(190,225,225,.64),0 16px 25px rgba(69,127,158,.09)!important}

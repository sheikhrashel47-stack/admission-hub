(() => {
  ...
  const executeSource = payload => {
    ...
    const sourceHtml = payload.bodyHtml.replace(/(<div class="spacer">)/, '$1<button class="source-course-inline-back" type="button" aria-label="কোর্স তালিকায় ফিরে যান" title="কোর্স তালিকায় ফিরে যান" onclick="SourceCourse.exit()">←</button>');

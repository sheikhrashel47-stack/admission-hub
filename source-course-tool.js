(() => {
  ...
  const executeSource = payload => {
    ...
    host.innerHTML = `<button class="source-course-native-back" type="button" aria-label="Admission Hub Dashboard-এ ফিরে যান" title="Admission Hub Dashboard-এ ফিরে যান" onclick="SourceCourse.exit()">←</button>${payload.bodyHtml}`;
  ...
  window.SourceCourse = {
    exit() { state.flash = null; navigate('dashboard'); },

(() => {
  ...
  function topicCard(topic) {
    ...
    return `<article class="urgent-topic-card">
      ...
      <div class="urgent-topic-actions">
        <button type="button" class="urgent-topic-action" onclick="openUrgentTopicForm('${escT(topic.subjectId)}','${escT(topic.id)}')">✏️ Edit</button>
        <button type="button" class="urgent-topic-action urgent-topic-delete" onclick="deleteUrgentTopic('${escT(topic.id)}')">🗑 Delete</button>
      </div>
    </article>`;
  }
  ...
  style.textContent = `.urgent-qbank-page{padding-bottom:24px}.urgent-qbank-head{margin-bottom:18px}.urgent-qbank-head-row{display:flex;align-items:center;gap:10px}.urgent-qbank-back{border:0;background:none;color:var(--emerald);font-size:34px;line-height:1;padding:0 4px;cursor:pointer}.urgent-kicker{font-size:10px;letter-spacing:1.4px;font-weight:800;color:#c9795f}.urgent-qbank-head h1{font-size:23px;line-height:1.15;margin:3px 0;color:var(--text)}.urgent-qbank-head p{font-size:12px;color:var(--sub);margin:4px 0 0}.urgent-add-topic{margin-left:auto;width:44px;height:44px;border:0;border-radius:14px;background:var(--emerald);color:#fff;font-size:25px;cursor:pointer;box-shadow:var(--shadow)}.urgent-topic-toolbar{display:flex;justify-content:space-between;align-items:end;gap:12px;margin:0 0 10px}.urgent-topic-toolbar strong{font-size:17px}.urgent-topic-toolbar span{font-size:11px;color:var(--sub);text-align:right}.urgent-topic-card{background:var(--card);border:1px solid var(--line);border-radius:17px;margin-bottom:11px;box-shadow:var(--shadow);overflow:hidden}.urgent-topic-main{width:100%;display:flex;align-items:center;gap:12px;padding:15px 15px 11px;border:0;background:transparent;text-align:left;cursor:pointer;color:var(--text)}.urgent-topic-main:active{background:var(--mint)}.urgent-topic-folder{font-size:26px}.urgent-topic-copy{flex:1;min-width:0}.urgent-topic-copy strong,.urgent-topic-copy small{display:block}.urgent-topic-copy strong{font-size:16px}.urgent-topic-copy small{font-size:12px;color:var(--sub);margin-top:4px}.urgent-topic-arrow{font-size:25px;color:var(--emerald)}.urgent-topic-actions{display:flex;gap:8px;padding:0 15px 12px}.urgent-topic-action{border:1px solid var(--line);border-radius:9px;background:var(--bg);color:var(--emerald-d);padding:7px 10px;font-size:12px;font-weight:700;cursor:pointer}.urgent-topic-delete{color:var(--red)}.urgent-topic-empty{text-align:center;background:var(--card);border:1px dashed var(--line);border-radius:18px;padding:34px 18px;color:var(--sub)}.urgent-topic-empty>div{font-size:38px}.urgent-topic-empty strong{display:block;color:var(--text);font-size:17px;margin-top:6px}.urgent-topic-empty p{font-size:13px;margin:6px 0 16px}.urgent-primary,.urgent-secondary{border:0;border-radius:11px;padding:11px 14px;font-weight:800;cursor:pointer}.urgent-primary{background:var(--emerald);color:#fff}.urgent-secondary{background:var(--mint);color:var(--emerald-d)}.urgent-modal-bg{position:fixed;inset:0;z-index:250;background:rgba(15,35,27,.38);display:flex;align-items:flex-end}.urgent-modal{width:100%;max-width:560px;margin:0 auto;background:var(--card);border-radius:20px 20px 0 0;padding:19px 16px calc(20px + var(--safe-b));box-shadow:0 -10px 30px rgba(0,0,0,.16)}.urgent-modal-head{display:flex;align-items:center;justify-content:space-between}.urgent-modal-head h2{margin:0;font-size:20px}.urgent-modal-head button{border:0;background:none;font-size:28px;color:var(--sub);cursor:pointer}.urgent-modal-sub{font-size:12px;color:var(--sub);margin:7px 0 14px}.urgent-label{display:block;font-size:12px;font-weight:800;color:var(--sub);margin:10px 0 5px}.urgent-label span{font-weight:500}.urgent-input{width:100%;box-sizing:border-box;border:1px solid var(--line);border-radius:11px;background:var(--card);color:var(--text);padding:11px 12px;font:inherit}.urgent-modal-actions{display:flex;justify-content:flex-end;gap:8px;margin-top:16px}@media(max-width:430px){.urgent-topic-toolbar{align-items:start;flex-direction:column;gap:3px}.urgent-topic-toolbar span{text-align:left}}`;
